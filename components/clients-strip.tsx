...
export function ClientsStrip() {
  ...
  return (
    <div className="relative flex overflow-hidden hover-pause [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
      <div className="flex w-max shrink-0 animate-marquee items-stretch gap-4 pr-4">
      ...
      <div className="flex w-max shrink-0 animate-marquee items-stretch gap-4 pr-4" aria-hidden="true">
        {clients.map((client, index) => (
